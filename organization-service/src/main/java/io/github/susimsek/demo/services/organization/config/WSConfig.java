package io.github.susimsek.demo.services.organization.config;

import io.github.susimsek.demo.services.organization.util.WsUtil;
...
import static io.github.susimsek.demo.services.organization.util.OrganizationEndpointUtil.*;
...
public class WSConfig extends WsConfigurerAdapter {
	...
	public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
		...
		return new ServletRegistrationBean(servlet, String.format("%s/*", WsUtil.BASE_PATH));
	}
